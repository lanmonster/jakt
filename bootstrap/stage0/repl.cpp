...
TRY((((builder).append_string(String(")")))));
__jakt_var_486 = TRY((((builder).to_string()))); goto __jakt_label_453;

}
__jakt_label_453:; __jakt_var_486.release_value(); }));
};/*case end*/
case 8: {
...
__jakt_var_487 = TRY((String::formatted(String("{}..{}"),from_output,to_output))); goto __jakt_label_454;

}
__jakt_label_454:; __jakt_var_487.release_value(); }));
};/*case end*/
case 9: {
...
TRY((((builder).append_string(String("]")))));
__jakt_var_488 = TRY((((builder).to_string()))); goto __jakt_label_455;

}
__jakt_label_455:; __jakt_var_488.release_value(); }));
};/*case end*/
case 10: {
...
TRY((((builder).append_string(String("}")))));
__jakt_var_489 = TRY((((builder).to_string()))); goto __jakt_label_456;

}
__jakt_label_456:; __jakt_var_489.release_value(); }));
};/*case end*/
case 11: {
...
TRY((((builder).append_string(String("]")))));
__jakt_var_490 = TRY((((builder).to_string()))); goto __jakt_label_457;

}
__jakt_label_457:; __jakt_var_490.release_value(); }));
};/*case end*/
case 12: {
...
return JaktInternal::ExplicitValue(({ Optional<String> __jakt_var_491; {
StringBuilder builder = TRY((StringBuilder::create()));
{
...
__jakt_var_491 = TRY((((builder).to_string()))); goto __jakt_label_458;

}
__jakt_label_458:; __jakt_var_491.release_value(); }));
};/*case end*/
case 21: {
...
return JaktInternal::ExplicitValue(({ Optional<String> __jakt_var_492; {
StringBuilder builder = TRY((StringBuilder::create()));
{
...
TRY((((builder).append_string(String(")")))));
__jakt_var_492 = TRY((((builder).to_string()))); goto __jakt_label_459;

}
__jakt_label_459:; __jakt_var_492.release_value(); }));
};/*case end*/
case 29: {
...
const utility::FileId file_id = TRY((((compiler)->get_file_id_or_register(TRY((path::Path::from_string(String("<repl>"))))))));
...
const repl::LineResult line_result = ({ Optional<repl::LineResult> __jakt_var_494;
auto __jakt_var_495 = [&]() -> ErrorOr<repl::LineResult> { return TRY((((editor).get_line()))); }();
if (__jakt_var_495.is_error()) {auto error = __jakt_var_495.release_error();
{
return {};
}
} else {__jakt_var_494 = __jakt_var_495.release_value();
}
__jakt_var_494.release_value(); });
...
const JaktInternal::Array<lexer::Token> tokens = ({ Optional<JaktInternal::Array<lexer::Token>> __jakt_var_496;
auto __jakt_var_497 = [&]() -> ErrorOr<JaktInternal::Array<lexer::Token>> { return TRY((lexer::Lexer::lex(((*this).compiler)))); }();
if (__jakt_var_497.is_error()) {{
continue;
}
} else {__jakt_var_496 = __jakt_var_497.release_value();
}
__jakt_var_496.release_value(); });
if (((tokens).is_empty())){
continue;
}
...
const parser::ParsedNamespace parsed_namespace = ({ Optional<parser::ParsedNamespace> __jakt_var_498;
auto __jakt_var_499 = [&]() -> ErrorOr<parser::ParsedNamespace> { return TRY((((parser).parse_namespace()))); }();
if (__jakt_var_499.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_498 = __jakt_var_499.release_value();
}
__jakt_var_498.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
auto __jakt_var_501 = [&]() -> ErrorOr<void> { return TRY((((((*this).typechecker)).typecheck_module(parsed_namespace,((*this).root_scope_id))))), ErrorOr<void>{}; }();
if (__jakt_var_501.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
}
...
const NonnullRefPtr<parser::ParsedStatement> parsed_statement = ({ Optional<NonnullRefPtr<parser::ParsedStatement>> __jakt_var_502;
auto __jakt_var_503 = [&]() -> ErrorOr<NonnullRefPtr<parser::ParsedStatement>> { return TRY((((parser).parse_statement(true)))); }();
if (__jakt_var_503.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_502 = __jakt_var_503.release_value();
}
__jakt_var_502.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
const NonnullRefPtr<types::CheckedStatement> checked_statement = ({ Optional<NonnullRefPtr<types::CheckedStatement>> __jakt_var_504;
auto __jakt_var_505 = [&]() -> ErrorOr<NonnullRefPtr<types::CheckedStatement>> { return TRY((((((*this).typechecker)).typecheck_statement(parsed_statement,((*this).root_scope_id), types::SafetyMode { typename types::SafetyMode::Safe() } ,JaktInternal::OptionalNone())))); }();
if (__jakt_var_505.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_504 = __jakt_var_505.release_value();
}
__jakt_var_504.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
...
const interpreter::StatementResult result = ({ Optional<interpreter::StatementResult> __jakt_var_506;
auto __jakt_var_507 = [&]() -> ErrorOr<interpreter::StatementResult> { return TRY((((interpreter)->execute_statement(checked_statement,((*this).root_interpreter_scope),utility::Span(((*this).file_id),static_cast<size_t>(0ULL),((line).length())))))); }();
if (__jakt_var_507.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_506 = __jakt_var_507.release_value();
}
__jakt_var_506.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
